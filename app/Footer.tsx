      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              ...
              <li><Link href="/privacy" className="hover:text-primary transition-colors">Aviso de Privacidad</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p className="font-medium">
            &copy; {new Date().getFullYear()} Mi Pacto. Creado para los freelancers en México.
          </p>

  ...
  return (
    <>
      <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-white/10 text-slate-800 pl-8 pr-4 py-2.5 text-sm font-bold focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition-all shadow-inner"
              />
            </div>
          </div>
        </div>
        ...
        {/* Full-width Tip card */}
        <div className="rounded-xl border border-indigo-500/10 bg-indigo-550/5 p-4 text-xs text-slate-550 leading-relaxed flex items-center gap-2">
      ...
      <div className={`p-4 rounded-xl border flex items-center gap-3 text-xs leading-relaxed transition-all duration-300 ${ isBalanceValid() ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-800 " : "bg-red-500/10 border-red-500/20 text-red-800 " }`}>
        {isBalanceValid() ? (
          <>
            ...
            <div key={index} className="glass p-4 rounded-2xl grid grid-cols-1 md:grid-cols-12 gap-4 items-center border-l-4 border-l-indigo-400">
              <div className="md:col-span-5">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white/10 text-slate-800 px-4 py-2 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition-all shadow-inner"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white/10 text-slate-800 pl-4 pr-8 py-2 text-sm font-bold focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition-all shadow-inner"
                  />
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white/10 text-slate-800 pl-7 pr-4 py-2 text-sm font-bold focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition-all shadow-inner"
                  />
                </div>
              </div>
      ...
      <div className="glass p-5 rounded-2xl border border-slate-200 bg-slate-50/10 flex flex-col gap-3">
        <span className="text-2xs font-extrabold text-slate-400 uppercase tracking-wider block">Desglose Fiscal Estimado (SAT México)</span>
        ...
        <div className="flex flex-col gap-2 text-xs">
          ...
          <div className="flex justify-between text-sm font-black text-slate-900">
            ...
            <span className="text-indigo-650">{formatMoney(totalAmount + (totalAmount * 0.16) - (retencionIsr ? totalAmount * 0.10 : 0) - (retencionIva ? totalAmount * 0.16 * (2 / 3) : 0), currency)}</span>
          </div>
        </div>
      </div>
